...
#sets[1]
##########fib
#sel_gmt=read.table("/home/zhuxq/nas/Xiaoqiang/opti.data/signatureVSimmune/CRC.immu.sigs.score/cell.cycle.txt",header = T,na.strings = c(""),sep = "\t")
sel_gmt=read.table("/home/zhuxq/nas/Xiaoqiang/opti.data/1.CGC.TE.CRC.REdiscoverTE/stats.20200311/4.model/kaps/marker.TEs.inhibition/additional/three.IFN.response.txt",header = T,na.strings = c(""),sep = "\t")
...
#sets[1]
#run ssgsea
load("/home/zhuxq/nas/Xiaoqiang/opti.data/1.CGC.TE.CRC.REdiscoverTE/output.plot/consensusClusterPlus/normal.excluded/expMatrixCRC.RData")
exprMatrix=expM
...
IFNtypes.score=score.gsva
save(IFNtypes.score,file="/home/zhuxq/nas/Xiaoqiang/opti.data/1.CGC.TE.CRC.REdiscoverTE/stats.20200311/4.model/kaps/marker.TEs.inhibition/additional/IFNtype.response.score.RData")

...
length(intersect(rownames(kaps.td), tumor.seg.cnv$Sample))
#
# Get subtype segments information
set1.seg.cnv <- tumor.seg.cnv[tumor.seg.cnv$Sample %in% rownames(subset(kaps.td, kaps.group=="set1")),]
set2.seg.cnv <- tumor.seg.cnv[tumor.seg.cnv$Sample %in% rownames(subset(kaps.td, kaps.group=="set2")),]
set3.seg.cnv <- tumor.seg.cnv[tumor.seg.cnv$Sample %in% rownames(subset(kaps.td, kaps.group=="set3")),]
set4.seg.cnv <- tumor.seg.cnv[tumor.seg.cnv$Sample %in% rownames(subset(kaps.td, kaps.group=="set4")),]
head(set1.seg.cnv)

write.table(set1.seg.cnv, file="4.model/kaps/mutation/cnv.v2/crc/data.cbio/tumor.set1.seg.txt", sep="\t", row.names=F, quote = F)
write.table(set2.seg.cnv, file="4.model/kaps/mutation/cnv.v2/crc/data.cbio/tumor.set2.seg.txt", sep="\t", row.names=F, quote = F)
write.table(set3.seg.cnv, file="4.model/kaps/mutation/cnv.v2/crc/data.cbio/tumor.set3.seg.txt", sep="\t", row.names=F, quote = F)
write.table(set4.seg.cnv, file="4.model/kaps/mutation/cnv.v2/crc/data.cbio/tumor.set4.seg.txt", sep="\t", row.names=F, quote = F)
length(unique(set1.seg.cnv$Sample))
...
pdf("4.model/kaps/mutation/cnv.v2/crc/data.cbio/cnv.scores.gistic.pdf",18,12)
par(mfrow=c(4,1), mar = par()$mar + c(3,0,0,3))


### set1 ###
scores <- read.table("4.model/kaps/mutation/cnv.v2/crc/data.cbio/set1/scores.gistic", sep="\t",header=T,stringsAsFactors = F)
...
### set2 ###
scores <- read.table("4.model/kaps/mutation/cnv.v2/crc/data.cbio/set2/scores.gistic", sep="\t",header=T,stringsAsFactors = F)
...
### set3 ###
scores <- read.table("4.model/kaps/mutation/cnv.v2/crc/data.cbio/set3/scores.gistic", sep="\t",header=T,stringsAsFactors = F)
...
### set4 ###
scores <- read.table("4.model/kaps/mutation/cnv.v2/crc/data.cbio/set4/scores.gistic", sep="\t",header=T,stringsAsFactors = F)
...
#########frequency plot
#############
pdf("4.model/kaps/mutation/cnv.v2/crc/data.cbio/cnv.frequence.pdf",18,12)
par(mfrow=c(4,1), mar = par()$mar + c(3,0,0,3))

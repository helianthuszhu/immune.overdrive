...
sel_gmt=read.table("/home/zhuxq/nas/Xiaoqiang/opti.data/signatureVSimmune/CRC.immu.sigs.score/strom.fib.emt.ecm.sigs.txt",header = T,na.strings = c(""),sep = "\t")
#sel_gmt[1:4,1:5]
dim(sel_gmt)
...
strom.fib.emt.ecm.sigs.score.kircfh=score.gsva
save(strom.fib.emt.ecm.sigs.score.kircfh,file="/home/zhuxq/nas/Xiaoqiang/opti.data/1.CGC.TE.CRC.REdiscoverTE/stats.20200311/8.KIRC/3.immune.sets.kirc/strom.fib.emt.ecm.sigs.kircfh.RData")

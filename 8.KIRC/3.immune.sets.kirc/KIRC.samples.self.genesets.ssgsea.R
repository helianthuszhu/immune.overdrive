...
genesets.self.score.kircfh=score.gsva
save(genesets.self.score.kircfh,file="/home/zhuxq/nas/Xiaoqiang/opti.data/1.CGC.TE.CRC.REdiscoverTE/stats.20200311/8.KIRC/3.immune.sets.kirc/genesets.self.score.kircfh.RData")

...
genesets.IFNs..kircfh=score.gsva
save(genesets.IFNs..kircfh,file="/home/zhuxq/nas/Xiaoqiang/opti.data/1.CGC.TE.CRC.REdiscoverTE/stats.20200311/8.KIRC/5.inhibitors/additional/genesets.IFNs.kircfh.RData")

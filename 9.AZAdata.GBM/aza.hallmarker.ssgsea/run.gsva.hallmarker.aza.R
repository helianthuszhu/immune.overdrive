...
#sets[1]
#run ssgsea
load("/home/zhuxq/nas/Xiaoqiang/opti.data/1.CGC.TE.CRC.REdiscoverTE/stats.20200311/9.AZAdata.GBM/aza.expmatrix.normd.symbol.RData")
exprMatrix=aza.expmatrix.normd.symbol
...
genesets.hall.marker.score.aza=score.gsva
save(genesets.hall.marker.score.aza,file="/home/zhuxq/nas/Xiaoqiang/opti.data/1.CGC.TE.CRC.REdiscoverTE/stats.20200311/9.AZAdata.GBM/aza.hallmarker.ssgsea/genesets.hallmarker.score.aza.RData")

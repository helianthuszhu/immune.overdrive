...
#sets[1]
#run ssgsea
load("/home/zhuxq/nas/Xiaoqiang/opti.data/1.CGC.TE.CRC.REdiscoverTE/stats.20200311/9.AZAdata.GBM/GSE5816/combat_edata.azaexp.GEOdata.GSE5816.RData")
exprMatrix=combat_edata.azaexp.GEOdata
...
genesets.hall.marker.score.aza.gse5816=score.gsva
save(genesets.hall.marker.score.aza.gse5816,file="/home/zhuxq/nas/Xiaoqiang/opti.data/1.CGC.TE.CRC.REdiscoverTE/stats.20200311/9.AZAdata.GBM/GSE5816/ssgsea/genesets.hallmarker.score.aza.gse5816.RData")

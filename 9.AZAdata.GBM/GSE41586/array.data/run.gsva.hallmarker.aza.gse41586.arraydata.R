...
#sets[1]
#run ssgsea
load("/home/zhuxq/nas/Xiaoqiang/opti.data/1.CGC.TE.CRC.REdiscoverTE/stats.20200311/9.AZAdata.GBM/GSE41586/array.data/combat_edata.azaexp.GEOdata.GSE41586.arraydata.RData")
exprMatrix=GEO.data_exp.agg
...
genesets.hall.marker.score.aza.gse41586.arraydata=score.gsva
save(genesets.hall.marker.score.aza.gse41586.arraydata,file="/home/zhuxq/nas/Xiaoqiang/opti.data/1.CGC.TE.CRC.REdiscoverTE/stats.20200311/9.AZAdata.GBM/GSE41586/array.data/genesets.hallmarker.score.aza.gse41586.arraydata.RData")

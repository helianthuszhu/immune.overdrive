...
#sets[1]
#run ssgsea
load("/home/zhuxq/nas/Xiaoqiang/opti.data/1.CGC.TE.CRC.REdiscoverTE/stats.20200311/9.AZAdata.GBM/GSE41586/batchcorrected/combat_edata.azaexp.gse41586.RData")
exprMatrix=combat_edata.azaexp.gse41586
...
genesets.hall.marker.score.aza.gse41586.batched=score.gsva
save(genesets.hall.marker.score.aza.gse41586.batched,file="/home/zhuxq/nas/Xiaoqiang/opti.data/1.CGC.TE.CRC.REdiscoverTE/stats.20200311/9.AZAdata.GBM/GSE41586/batchcorrected/genesets.hallmarker.score.aza.gse41586.batched.RData")

...
#sets[1]
#run ssgsea
load("/home/zhuxq/nas/Xiaoqiang/opti.data/1.CGC.TE.CRC.REdiscoverTE/stats.20200311/9.AZAdata.GBM/GSE41586/expdata.gse41586.agg.sel.noneedtodobatcheffect.RData")
exprMatrix=expdata.gse41586.agg.sel
...
genesets.hall.marker.score.aza.gse41586=score.gsva
save(genesets.hall.marker.score.aza.gse41586,file="/home/zhuxq/nas/Xiaoqiang/opti.data/1.CGC.TE.CRC.REdiscoverTE/stats.20200311/9.AZAdata.GBM/GSE41586/ssgsea/genesets.hallmarker.score.aza.gse41586.RData")

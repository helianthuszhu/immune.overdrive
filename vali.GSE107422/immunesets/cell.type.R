...
sets[1]
##
sel_gmt=read.table("/home/zhuxq/nas/Xiaoqiang/opti.data/signatureVSimmune/CRC.immu.sigs.score/cell.type.LM22.3.Ths.2.fibendo.txt",header = T,na.strings = c(""),sep = "\t")
#sel_gmt[1:4,1:5]
dim(sel_gmt)
sets=as.list(sel_gmt)
sets=lapply(sets, function(x) x[!is.na(x)])
...
#run ssgsea
load("/home/zhuxq/nas/Xiaoqiang/opti.data/1.CGC.TE.CRC.REdiscoverTE/stats.20200311/vali.GSE107422/TPM/TPM.expMatrix.GSE107422.RData")
exprMatrix=df.sel.agg
...
genesets.cell.type.score.GSE107422=score.gsva
save(genesets.cell.type.score.GSE107422,file="/home/zhuxq/nas/Xiaoqiang/opti.data/1.CGC.TE.CRC.REdiscoverTE/stats.20200311/vali.GSE107422/immunesets/genesets.cell.type.score.GSE017422.RData")

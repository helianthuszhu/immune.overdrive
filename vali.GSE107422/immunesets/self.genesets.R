...
genesets.self.score.gse107422=score.gsva
save(genesets.self.score.gse107422,file="/home/zhuxq/nas/Xiaoqiang/opti.data/1.CGC.TE.CRC.REdiscoverTE/stats.20200311/vali.GSE107422/immunesets/genesets.self.score.gse107422.RData")
